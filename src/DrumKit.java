...
public class DrumKit implements MouseListener {
	...
	private void getGoing() throws MalformedURLException {
		...
		jeff.setSize(1000, 1000);
		// 4. Set the title of the frame
		jeff.setTitle("S.H.I.E.L.D.");
		// 5. Make a JPanel variable and initialize it using "new JPanel().
		JPanel daisy = new JPanel();
		...
		daisy.setLayout(new GridLayout());
		...
		// each one.
		String poopy = "poopy.jpg";
		poopyLabelWithImage = createLabelImage(poopy);

		daisy.setLayout(new GridLayout());

		poopyLabelWithImage.addMouseListener(this);

		String violin = "violina.jpg";
		violinLabelWithImage = createLabelImage(violin);

		daisy.setLayout(new GridLayout());

		violinLabelWithImage.addMouseListener(this);
		daisy.add(drumLabelWithImage);
		daisy.add(poopyLabelWithImage);
		daisy.add(violinLabelWithImage);
		jeff.add(daisy);
		jeff.pack();
	}
	...
	public void mouseClicked(MouseEvent e) {
		...
		JLabel poopyClicked = (JLabel) e.getSource();
		JLabel violinClicked = (JLabel) e.getSource();
		...
		if (poopyLabelWithImage == poopyClicked) {
			playSound("poopybark.wav");
		}
		if (violinLabelWithImage == violinClicked) {
			playSound("vsound.wav");
		}
